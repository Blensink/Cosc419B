...
function scene:show( event )
	...
	if ( phase == "will" ) then
		...
		speechBubble = display.newImageRect( "img/storySpeech1.png", 350, 263 )
		speechBubble.x = display.contentCenterX + 10
		speechBubble.y = display.contentCenterY - 70

		speechBubble2 = display.newImageRect( "img/storySpeech12.png", 350, 263 )
		speechBubble2.alpha = 0
		speechBubble2.x = display.contentCenterX + 10
		speechBubble2.y = display.contentCenterY - 70
		...
		displayGroup:insert( speechBubble2 )
