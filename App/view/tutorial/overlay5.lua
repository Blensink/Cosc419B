...
function scene:create( event )
	...
	-----------------------------------------------------------------------------
	local overlayHole = display.newImageRect( "img/overlayWithHole2.png", 1000, 1000 )
	overlayHole.x = display.contentCenterX + 35
	overlayHole.y = display.contentCenterY
	...
	scientist.y = display.contentCenterY +30
	overlayGroup:insert( scientist )

	local speechBubble = display.newImageRect( "img/speechBubble5.png", 300, 300 )
	speechBubble.x = speechBubble.width/2 - 15
	speechBubble.y = speechBubble.height/2 - 100
	...
	bigRedArrow.y = display.contentHeight*3/4
	bigRedArrow.yScale = -1
...
function scene:show( event )
	...
	elseif ( phase == "did" ) then
		...
		local backgroundMusic = audio.loadSound( "sound/story5.wav")
