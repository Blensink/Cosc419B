...
function scene:create( event )
	...
	-----------------------------------------------------------------------------
	local overlayHole = display.newImageRect( "img/overlayWithHole3.png", 1000, 1000 )
	overlayHole.x = display.contentWidth - 50
	overlayHole.y = display.contentCenterY - 100
	...
	scientist.y = display.contentHeight - scientist.height/2
	scientist.xScale = -1
	overlayGroup:insert( scientist )

	local speechBubble = display.newImageRect( "img/speechBubble6.png", 300, 213 )
	speechBubble.x = speechBubble.width/2 - 30
	speechBubble.y = display.contentCenterY - 100
	overlayGroup:insert( speechBubble )

	local bigRedArrow = display.newImageRect( "img/bigRedArrow.png", 150, 80 )
	bigRedArrow.x = display.contentCenterX + 110
	bigRedArrow.y = display.contentHeight*3/4 + 20
	bigRedArrow.rotation = 90
...
function scene:show( event )
	...
	elseif ( phase == "did" ) then
		...
		local backgroundMusic = audio.loadSound( "sound/story6.wav")
